  ...
  return (
    <div className="footer">
      <div className="footer__reviews">
        ...
        <span className="reviews__users"> Mr. and Mrs. Baxter, UK</span>
        <div className="flex">
          <button className="reviews__last">
            <svg
              width="14"
              height="21"
              viewBox="0 0 14 21"
          ...
          <button className="reviews__next">
            <svg
              width="14"
              height="20"
              viewBox="0 0 14 20"
      ...
      <div className="footer__end">
        <div className="col-4">
          <h2 className="footer__title">LUXURY Hotels</h2>
          <p className="footer__d">
            497 Evergreen Rd. Roseville, CA 95673 +44 345 678 903
            luxury_hotels@gmail.com
          </p>
        </div>
        <div className="col-4">
          <p className="footer__des">About Us Contact Terms & Conditions</p>
        </div>
        <div className="col-4">
